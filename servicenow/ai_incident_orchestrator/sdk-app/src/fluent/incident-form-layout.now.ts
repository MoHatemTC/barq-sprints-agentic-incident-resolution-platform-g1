...
export const aiRetryCountElement = Record({ $id: Now.ID['form_element_15'], table: 'sys_ui_element', data: { sys_ui_section: aiIncidentOrchestratorSection, element: 'x_2215032_ai_inc_0_ai_retry_count', type: 'element', position: 15 } })
